...
FILE = os.path.join(HUB, "temporary", "Form - Aug 18, 2026_leads_2026-05-27_2026-08-24.csv")
...
json.dump(plan, open(os.path.join(HERE, "li_push_aug24.json"), "w", encoding="utf-8"),
