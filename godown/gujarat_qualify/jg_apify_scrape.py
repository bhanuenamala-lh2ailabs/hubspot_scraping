...
OUT_DIR = os.path.join(HUB, "godown", "gujarat_qualify", "apify_out_jg")
os.makedirs(OUT_DIR, exist_ok=True)

urls = json.load(open("/tmp/jg_profile_urls.json"))
...
json.dump(dedup, open("/tmp/jg_company_urls.json", "w"))
