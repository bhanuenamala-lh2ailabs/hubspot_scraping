# -*- coding: utf-8 -*-
"""Push the final MP Sales Nav ready-list, 50:50 Yuktha/Lamiya. Same shape as the
Gujarat/Jaipur pushes: final re-dedup against HubSpot right before writing, lead_source stays
"LinkedIn Sales Nav ( IT Services )", source_tab="mp_salesnav", contact website set
...
Usage: python3 mp_push.py [--apply]
"""
...
ready = json.load(open("/tmp/mp_ready.json"))
