# -*- coding: utf-8 -*-
"""SignalHire-then-Apollo enrichment for the MP Sales Nav qualified list.
...
IN_JSON = "/tmp/mp_qualified.json"
OUT_CSV = os.path.join(HUB, "temporary", "MP_IT_qualified_enriched.csv")
STATE = os.path.join(os.path.dirname(__file__), "mp_enrich_state.json")
