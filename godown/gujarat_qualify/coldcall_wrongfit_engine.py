...
IN_CSV = "godown/gujarat_qualify/apify_out_coldcall/people_companies_joined.csv"
OUT_CSV = "godown/gujarat_qualify/apify_out_coldcall/wrongfit_predictions.csv"
