# -*- coding: utf-8 -*-
"""SignalHire-then-Apollo enrichment for the Jaipur Sales Nav qualified list.
...
IN_JSON = "/tmp/jaipur_qualified.json"
OUT_CSV = os.path.join(HUB, "temporary", "Jaipur_IT_qualified_enriched.csv")
STATE = os.path.join(os.path.dirname(__file__), "jaipur_enrich_state.json")
