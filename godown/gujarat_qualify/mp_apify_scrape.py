...
OUT_DIR = os.path.join(HUB, "godown", "gujarat_qualify", "apify_out_mp")
os.makedirs(OUT_DIR, exist_ok=True)

urls = json.load(open("/tmp/mp_profile_urls.json"))
...
json.dump(dedup, open("/tmp/mp_company_urls.json", "w"))
