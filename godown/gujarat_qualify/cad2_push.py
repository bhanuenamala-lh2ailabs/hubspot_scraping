# -*- coding: utf-8 -*-
"""Push CAD-campaign group A, ALL to Yuktha, lead_source=CAD_salesNav. Final re-dedup against
HubSpot right before writing. Domain conflicts auto-attach the contact to the existing deal.

Usage: python3 cad2_push.py [--apply]
"""
import os, sys, json, re, time, urllib.request, urllib.error, csv
...
enriched = list(csv.DictReader(open(os.path.join(HUB, "temporary", "CAD2_groupA_enriched.csv"),
                                     encoding="utf-8")))
