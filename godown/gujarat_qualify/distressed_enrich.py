# -*- coding: utf-8 -*-
"""SignalHire-then-Apollo enrichment for the distressed-startups qualified list. Anyone
SignalHire leaves without a valid +91 mobile falls back to Apollo people/match for one more
shot at a phone/email.
"""
...
IN_JSON = "/tmp/distressed_qualified.json"
OUT_CSV = os.path.join(HUB, "temporary", "Distressed_Startups_qualified_enriched.csv")
STATE = os.path.join(os.path.dirname(__file__), "distressed_enrich_state.json")
