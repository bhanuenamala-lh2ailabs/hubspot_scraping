...
OUT = os.path.join(HERE, "apify_out_nasscom")

people = json.load(open(os.path.join(OUT, "people_raw.json")))
companies = json.load(open(os.path.join(OUT, "companies_raw.json")))
input_company_urls = json.load(open("/tmp/nasscom_company_urls.json"))
input_people = json.load(open("/tmp/nasscom_deal_linkedins.json"))
