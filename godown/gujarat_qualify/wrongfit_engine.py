...
IN_CSV = "godown/gujarat_qualify/apify_out/people_companies_joined.csv"
OUT_CSV = "godown/gujarat_qualify/apify_out/wrongfit_predictions.csv"
...
# Hard disqualifiers: no DEV_SIGNAL rescue applies to these two. A company can mention some
# dev-sounding work while still being fundamentally a marketing shop or a training academy —
# e.g. SAFA Infotech ("website designing & development... Digital Marketing") is a marketing-
# led shop, not a dormant-codebase target, despite the dev-flavored copy.
