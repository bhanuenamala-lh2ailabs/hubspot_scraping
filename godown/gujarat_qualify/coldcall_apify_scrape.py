...
OUT_DIR = os.path.join(HUB, "godown", "gujarat_qualify", "apify_out_coldcall")
os.makedirs(OUT_DIR, exist_ok=True)

urls = json.load(open("/tmp/coldcall_profile_urls.json"))
...
json.dump(dedup, open("/tmp/coldcall_company_urls.json", "w"))
