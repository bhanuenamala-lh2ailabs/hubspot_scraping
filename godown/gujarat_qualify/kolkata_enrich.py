# -*- coding: utf-8 -*-
"""SignalHire-then-Apollo enrichment for the Kolkata Sales Nav Apify-screened (LIKELY_FIT /
NEEDS_REVIEW) list. Anyone SignalHire leaves without a valid +91 mobile falls back to Apollo
people/match (by person name + company name) for one more shot at a phone/email.
"""
...
IN_JSON = "/tmp/kolkata_apify_kept.json"
OUT_CSV = os.path.join(HUB, "temporary", "Kolkata_IT_qualified_enriched.csv")
STATE = os.path.join(os.path.dirname(__file__), "kolkata_enrich_state.json")
