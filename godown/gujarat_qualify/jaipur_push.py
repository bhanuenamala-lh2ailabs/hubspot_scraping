# -*- coding: utf-8 -*-
"""Push the final Jaipur Sales Nav ready-list, 50:50 Yuktha/Lamiya. Same shape as the Gujarat
push: final re-dedup against HubSpot right before writing (state can shift since compiling),
lead_source stays "LinkedIn Sales Nav ( IT Services )", source_tab="jaipur_salesnav",
contact website set from the company's email domain where derivable.

Usage: python3 jaipur_push.py [--apply]
"""
...
ready = json.load(open("/tmp/jaipur_ready.json"))
