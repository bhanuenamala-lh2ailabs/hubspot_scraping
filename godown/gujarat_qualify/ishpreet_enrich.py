# -*- coding: utf-8 -*-
"""SignalHire-then-Apollo enrichment for the Ishpreet Sales Nav qualified list.
...
IN_JSON = "/tmp/ishpreet_netnew.json"
OUT_CSV = os.path.join(HUB, "temporary", "Ishpreet_IT_qualified_enriched.csv")
STATE = os.path.join(os.path.dirname(__file__), "ishpreet_enrich_state.json")
