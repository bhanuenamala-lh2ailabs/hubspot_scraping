# -*- coding: utf-8 -*-
"""SignalHire-then-Apollo enrichment for the freshly-discovered India startups list."""
...
IN_JSON = "/tmp/similarorgs_confirmed.json"
OUT_CSV = os.path.join(HUB, "temporary", "India_Startups_SimilarOrgs_enriched.csv")
STATE = os.path.join(os.path.dirname(__file__), "enrich_state_similarorgs.json")
...
print(f"\nwrote {OUT_CSV}")
print(f"valid +91 mobile: {n_mobile}/{len(results)} | apollo fallback used: {apollo_used} ({apollo_hit} hits)")
