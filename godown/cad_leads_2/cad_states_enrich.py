...
IN_JSON = "/tmp/cad_states_confirmed.json"
OUT_CSV = os.path.join(HUB, "temporary", "CAD_states_enriched.csv")
STATE = os.path.join(os.path.dirname(__file__), "cad_states_enrich_state.json")
